...
/** True once the resource is known to the system's schema validator. */
export function isActionResourceRegistered() {
    return Boolean(CONFIG.DH?.RESOURCE?.character?.all?.[ACTIONS_RESOURCE]);
}
